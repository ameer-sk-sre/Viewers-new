...
const StudyBrowser = ({
  ...
  return (
    <ScrollArea>
      <div
        className="radiomind-study-browser bg-background flex flex-1 flex-col gap-[4px]"
        data-cy={'studyBrowser-panel'}
      >
        <div className="flex flex-col gap-[4px]">
          {showSettings && (
            <div className="radiomind-study-browser-settings w-100 bg-background flex h-[48px] items-center justify-center gap-[10px] px-[8px] py-[10px]">
              <>
