...
const Thumbnail = ({
  ...
  const renderThumbnailPreset = () => {
    return (
      ...
      >
        <div className="h-[104px] w-[110px]">
          <div className="relative bg-background">
            {shouldRenderThumbnailImage ? (
              <img
                src={imageSrc}
                alt={imageAltText}
                className="h-[104px] w-[110px] rounded object-contain"
              ...
              <div className="bg-background h-[104px] w-[110px] rounded">{children}</div>
            )}
        ...
        <div className="flex h-[52px] w-[110px] flex-col justify-start pt-px">
          <Tooltip>
            <TooltipContent>{description}</TooltipContent>
            <TooltipTrigger>
              <div
                className="text-foreground min-h-[18px] w-[110px] overflow-hidden text-ellipsis whitespace-nowrap pb-0.5 pl-1 text-left text-[12px] font-normal leading-4"
  ...
  return (
    <div
      className={classnames(
        className,
        'radiomind-thumbnail bg-muted group flex select-none flex-col rounded outline-none',
        isDraggable && 'hover:bg-primary/30 cursor-pointer',
        !isDraggable && 'cursor-default',
        viewPreset === 'thumbnails' && 'h-[166px] w-[118px]',
