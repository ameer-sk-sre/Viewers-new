...
const ViewerRootRedirect = () => {
  const [appConfig] = useAppConfig();
  const params = new URLSearchParams(window.location.search);

  if (!params.get('StudyInstanceUIDs') && appConfig.radiomindDefaultStudyInstanceUIDs) {
    params.set('StudyInstanceUIDs', appConfig.radiomindDefaultStudyInstanceUIDs);
  }
...
const createRoutes = ({
  ...
  const ViewerRootRoute = {
    path: '/',
    children: ViewerRootRedirect,
    private: true,
  };
  ...
  const allRoutes = [
    ...routes,
    ...(showStudyList ? [WorkListRoute] : [ViewerRootRoute]),
    ...(customRoutes?.routes || []),
    ...bakedInRoutes,
